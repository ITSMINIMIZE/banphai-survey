...
(function () {
  ...
  const DESTS  = [
    ...
    { n: 'โรงงานในนิคมอุตสาหกรรม', c: '16.048000, 102.742000', t: 'ที่ทำงาน' },
    { n: 'ตลาดชุมชนบ้านลาน',      c: '15.982000, 102.793000', t: 'ตลาด / ร้านค้า' },
    { n: 'โรงเรียนแคนเหนือ',       c: '15.940000, 102.770000', t: 'สถาบันการศึกษา' },
    { n: 'วัดหินตั้ง',             c: '16.095000, 102.780000', t: 'ศาสนสถาน' },
